...
import { GPUSpec, TPUSpec, CalculationResult } from '../types/hardware';
import { Calculator as CalcIcon, Users, Clock, DollarSign, TrendingUp, AlertTriangle } from 'lucide-react';

interface CalculatorProps {
  selectedHardware: (GPUSpec | TPUSpec)[];
}

const Calculator: React.FC<CalculatorProps> = ({ selectedHardware }) => {
  ...
  }, [selectedHardware, nodeCount, unitsPerNode, utilizationRate, monthlyHours]);
  ...
  const calculateResults = () => {
    ...
    let monthlyCost = 0;
    if (hardware.cloudProviders.length > 0) {
